...
export default function PaySlipButton({ employee, period, record, company }: PaySlipButtonProps) {
    return (
        <button
            onClick={() => generateIndividualPaySlip(employee, period, record, company)}
